...
#   c) node1 mines 32 blocks, so now node 0 has 500000ESC, node 1 has 4250ESC, node2 has none.
#   d) node0 sends 601 ESC to node2, in two transactions (301 ESC, then 300 ESC).
