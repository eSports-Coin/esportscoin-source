Contributing to eSportscoin Core
==================================

The eSportscoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the eSportscoin Core project, and is not to be
confused with overall eSportscoin Network Protocol consensus changes.

Whether a pull request is merged into eSportscoin Core rests with the project merge
...
Patches that change eSportscoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the eSportscoin consensus, it must have been
...
The project leader is the release manager for each eSportscoin Core release.
