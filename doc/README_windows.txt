...
Intro
-----
eSportscoin (ESC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. eSportscoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run esportscoin-qt.exe.

eSportscoin Core is the original eSportscoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of eSportscoin transactions;
