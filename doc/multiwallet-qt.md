...
In order to support loading of multiple wallets in esportscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is esportscoin.cpp.
...
Changes to esportscoin.cpp
----------------------
esportscoin.cpp is the entry point into esportscoin-qt, and as such, will require some minor modifications to provide hooks for
