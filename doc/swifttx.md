...
This mechanism has been integrated into Bitcore-Node-eSportscoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/esportscoingame/insight-api-esportscoin#web-socket-api](https://github.com/esportscoingame/insight-api-esportscoin#web-socket-api)
* API: [https://github.com/esportscoingame/insight-api-esportscoin#swifttx-transactions](https://github.com/esportscoingame/insight-api-esportscoin#swifttx-transactions)
...
By default, the eSportscoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the eSportscoin Core daemon:
