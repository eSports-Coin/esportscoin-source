...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a eSportscoin initiative\n"
            "  vote-alias         - Vote on a eSportscoin initiative\n"
            "  vote               - Vote on a eSportscoin initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"esportscoin-address\" monthly-payment\n"
            ...
            "5. \"esportscoin-address\":   (string, required) ESC address to send payments to\n"
            "6. monthly-payment:  (numeric, required) Monthly payment amount\n"

            "\nResult:\n"
            "\"xxxx\"       (string) proposal fee hash (if successful) or error message (if failed)\n"
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://esportscoingame.online/t/test-proposal\" 2 820800 \"Bk39HssARwPds51FV9wSprCPzAxniVZeZ6\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://esportscoingame.online/t/test-proposal\" 2 820800 \"Bk39HssARwPds51FV9wSprCPzAxniVZeZ6\" 500"));
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"esportscoin-address\" monthly-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://esportscoingame.online/t/test-proposal\" 2 820800 \"Bk39HssARwPds51FV9wSprCPzAxniVZeZ6\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://esportscoingame.online/t/test-proposal\" 2 820800 \"Bk39HssARwPds51FV9wSprCPzAxniVZeZ6\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) ESC address of payment\n"
