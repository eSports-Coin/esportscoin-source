...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop eSportscoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "eSportscoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* eSportscoin features */
        {"esportscoin", "masternode", &masternode, true, true, false},
        {"esportscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"esportscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"esportscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"esportscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"esportscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"esportscoin", "startmasternode", &startmasternode, true, true, false},
        {"esportscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"esportscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"esportscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"esportscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"esportscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"esportscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"esportscoin", "mnbudget", &mnbudget, true, true, false},
        {"esportscoin", "preparebudget", &preparebudget, true, true, false},
        {"esportscoin", "submitbudget", &submitbudget, true, true, false},
        {"esportscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"esportscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"esportscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"esportscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"esportscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"esportscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"esportscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"esportscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"esportscoin", "mnsync", &mnsync, true, true, false},
        {"esportscoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> esportscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25888/\n";
}
