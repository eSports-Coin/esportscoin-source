...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("eSportscoin Core esportscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  esportscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded esportscoin transaction") + "\n" +
                               "  esportscoin-tx [options] -create [commands]   " + _("Create hex-encoded esportscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded esportscoin transaction
