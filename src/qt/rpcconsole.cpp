...
// Repair parameters
const QString ESPORTSCOINWALLET("-esportscoinwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_esportscoinwallet, SIGNAL(clicked()), this, SLOT(walleteSportscoin()));
...
/** Restart wallet with "-esportscoinwallet" */
void RPCConsole::walleteSportscoin()
{
    buildParameterlist(ESPORTSCOINWALLET);
}
...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    args.removeAll(ESPORTSCOINWALLET);
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the eSportscoin RPC console.") + "<br>" +
