...
/* eSportscoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "eSportscoin"
#define QAPP_ORG_DOMAIN "esportscoingame.online"
#define QAPP_APP_NAME_DEFAULT "eSportscoin-Qt"
#define QAPP_APP_NAME_TESTNET "eSportscoin-Qt-testnet"
