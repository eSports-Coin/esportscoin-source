                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("eSportscoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ESC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and esportscoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About eSportscoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about eSportscoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for eSportscoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ESC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ESC addresses"));
    ...
    openAction->setStatusTip(tr("Open a esportscoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the eSportscoin Core help message to get a list with possible eSportscoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("eSportscoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to eSportscoin network", "", count));
}
...
{
    QString strTitle = tr("eSportscoin Core"); // default title
