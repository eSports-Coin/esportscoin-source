...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("eSportscoin Core"),
     ...
     * override -datadir in the esportscoin.conf file in the default data directory
     * (to be consistent with esportscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
