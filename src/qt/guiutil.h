...
/** Utility functions used by the eSportscoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ESC addresses in monospace font
...
// Parse "esportscoin:" URI into recipient object, return true on successful parsing
