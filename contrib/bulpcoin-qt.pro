...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/esportscoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/esportscoin-cli.cpp \
           src/esportscoin-tx.cpp \
           src/esportscoin.cpp \
           src/db.cpp \
           ...
           src/qt/esportscoin.cpp \
           src/qt/esportscoinstrings.cpp \
...
RESOURCES += src/qt/esportscoin.qrc src/qt/esportscoin_locale.qrc

TRANSLATIONS += src/qt/locale/esportscoin_bg.ts \
                src/qt/locale/esportscoin_de.ts \
                src/qt/locale/esportscoin_en.ts \
                src/qt/locale/esportscoin_es.ts \
                src/qt/locale/esportscoin_fi.ts \
                src/qt/locale/esportscoin_fr.ts \
                src/qt/locale/esportscoin_it.ts \
                src/qt/locale/esportscoin_ja.ts \
                src/qt/locale/esportscoin_pl.ts \
                src/qt/locale/esportscoin_pt.ts \
                src/qt/locale/esportscoin_ru.ts \
                src/qt/locale/esportscoin_sk.ts \
                src/qt/locale/esportscoin_sv.ts \
                src/qt/locale/esportscoin_vi.ts \
                src/qt/locale/esportscoin_zh_CN.ts \
                src/qt/locale/esportscoin_zh_TW.ts
